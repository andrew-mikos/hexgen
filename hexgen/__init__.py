...
def draw_grid(hex_grid):
    ...
    #HexGridDraw(hex_grid, color_zone, "map_latitude.png",  rivers=False, show_coasts=False)
    ...
    #HexGridDraw(hex_grid, color_wind_end_year, "map_wind_end_year.png",  rivers=False, show_coasts=True)
    #HexGridDraw(hex_grid, color_wind_mid_year, "map_wind_mid_year.png",  rivers=False, show_coasts=True)
